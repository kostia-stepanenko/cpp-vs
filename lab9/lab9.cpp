...
public:
    ...
    void remove() ///in our case, this==address of 60
    {
        BinaryTree<T>* leaf;
    ...
    int maxHeight(){
        ...
        int right_height = 0;
            ...
            if (left_son != NULL) {
                left_height->maxHeight();
            }
            if (right_son != NULL) {
                right_height->maxHeight();
            }
    ...
    int diffHeight() {
        ...
        if (left_son != NULL) {
            left_height->diffHeight();
        }
        if (right_son != NULL) {
            right_height->diffHeight();
        }
        return std::abs(left_son->diffHeight() -  right_son->diffHeight());
    }
    */
    ...
    void displayLevel(int level) {
        ...
        {
            if (left_son != NULL)
                left_son->displayLevel(level - 1);

            if (right_son != NULL)
                right_son->displayLevel(level - 1);
        }
    }
...
int main() {
  ...
  //  cout<<"new root: "<<*r->pinfo<<endl;
    ...
    cout << "\n" << r->find(8) << endl;
    /*
    cout << "max height is" << r->maxHeight() << endl;
   cout << "difference height is" << r->diffHeight() << endl;
   */
    r->displayLevel(2);
    return 0;
}
